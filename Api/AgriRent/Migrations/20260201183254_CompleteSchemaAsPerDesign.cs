...
{
    /// <inheritdoc />
    public partial class CompleteSchemaAsPerDesign : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxEquipment = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentAvailability", x => x.AvailabilityId);
                    table.ForeignKey(
                        name: "FK_EquipmentAvailability_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentBookings", x => x.BookingId);
                    table.ForeignKey(
                        ...
                        principalColumn: "EquipmentId");
                    table.ForeignKey(
                        name: "FK_EquipmentBookings_Users_FarmerId",
                        column: x => x.FarmerId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentImages", x => x.ImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentAvailability_EquipmentId_StartDate_EndDate",
                table: "EquipmentAvailability",
